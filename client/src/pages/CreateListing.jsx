  ...
  const storeImage = async (file) => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        // Check if discount price is greater than or equal to regular price
        if (formData.discountPrice > 0 && formData.discountPrice >= formData.regularPrice) {
          return setError('Discount price cannot be greater than or equal to regular price.');
        }
